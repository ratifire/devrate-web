export const styles = {
  ...
  figure: () => ({
    ...
    borderRadius: '4px',
    cursor: 'pointer',
    backgroundImage: `url("data:image/svg+xml;charset=UTF-8,%3csvg width='228' height='138' viewBox='0 0 228 138' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath fill-rule='evenodd' clip-rule='evenodd' d='M175 122C175 130.837 167.837 138 159 138H16C7.16344 138 0 130.837 0 122V16C0 7.16345 7.16344 0 16 0H212C220.837 0 228 7.16344 228 16V75C228 83.8366 220.837 91 212 91H191C182.163 91 175 98.1634 175 107V122Z' fill='%233E3E40'/%3e%3c/svg%3e ")`,
