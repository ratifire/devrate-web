...
import { ConvertMilliInYears } from '@utils/helpers/convertMilliInYears';
...
const InterviewInfo = () => {
  ...
  const { dateTime, attendeeId, specialization, attendeeMasteryLevel, attendeeSpecialization } = interviewData;
