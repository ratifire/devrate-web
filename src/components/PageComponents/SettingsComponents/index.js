...
import { ChangeEmail } from '@components/PageComponents/SettingsComponents/SettingsGeneral';

export { SettingsSideBar, EmailNotifications, TelegramNotifications, SettingsTitle, ChangeEmail };
