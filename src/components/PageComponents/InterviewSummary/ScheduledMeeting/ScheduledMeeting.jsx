    ...
    <Box sx={styles.wrapper}>
      <Box sx={styles.boxTitle}>
        <Typography component='h6' variant='h6'>
          {t('interviews.scheduledMeeting.title')}
        </Typography>
      ...
      <Box sx={styles.boxInfo}>
        ...
        <Typography component='p' sx={styles.boxInfoText} variant='subtitle2'>
          {t('interviews.scheduledMeeting.participants')}:
      ...
      <Box sx={styles.boxParameters}>
        <Box sx={styles.boxParametersInfo}>
          <Typography component='p' variant='subtitle2'>
            {t('interviews.scheduledMeeting.language')}
          </Typography>
        ...
        <Box sx={styles.boxParametersInfo}>
          <Typography component='p' variant='subtitle2'>
            {t('interviews.scheduledMeeting.duration')}
          </Typography>
          <Typography component='p' variant='body'>
            60 хв.
          </Typography>
        ...
        <Box sx={styles.boxParametersInfo}>
          <Typography component='p' variant='subtitle2'>
            {t('interviews.scheduledMeeting.platform')}
          </Typography>
      ...
      <Typography component='p' variant='body2'>
        <Trans
          ...
          i18nKey='interviews.scheduledMeeting.link'
        />
      </Typography>
      <Box sx={styles.boxBtn}>
        <ButtonDef label={t('interviews.scheduledMeeting.canceledMeeting')} sx={styles.btn} variant='outlined' />
        <ButtonDef label={t('interviews.scheduledMeeting.joinMeeting')} sx={styles.btn} variant='contained' />
      </Box>
    </Box>
  );
};
