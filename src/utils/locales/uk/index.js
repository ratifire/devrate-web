  ...
  translation: {
    ...
    faqText: {
      ...
      question15: {
        ...
        answer:
          'Все, що вам потрібно — це базова підготовка за обраними вами навичками. Співбесіда відбувається онлайн через сервіс MiroTalk, тому важливо знайти спокійне місце, переконатися в наявності стабільного інтернету та бути готовим до нового досвіду.',
      },
      question16: {
