export const uk = {
  translation: {
    ...
    notifications: {
      ...
      interviewRejected:
        'Співбесіду з {{rejectionUserFirstName}}, заплановану на {{date}}, скасовано. Ми вже працюємо над пошуком нового співрозмовника та скоро повідомимо Вас',
    ...
    faqText: {
      ...
      question1: {
        ...
        answer:
          "Щоб подати заявку на співбесуду необхідно, перейти на екран «Спеціалізації», вибрати одну з своїх спеціалазцій, за якою буде проводитись інтервью, далі натиснути на кнопку «Запланувати співбесіду» та вибрати вашу роль. Якщо ви хочете бути інтервьювером, тобто оцінити когось - обирайте «Стати інтерв'юером», якщо ви хочете щоб вас оцінили, тобто бути кандидатом – обирайте «Запланувати співбесіду». Далі на формі вибрати підходящі для вас дні та час, і натиснути кнопку «Запланувати». Заявку створено, як тільки знайдеться співрозмовник, ви отримаєте email та нотифікацію про співбесіду.",
      },
      question2: {
      ...
      question10: {
        ...
        answer:
          'Практична співбесіда зазвичай триває до 40 хвили, залежно від типу співбесіди та узгодженого формату між вами та іншим учасником.',
      },
      question11: {
      ...
      question12: {
        ...
        answer:
          'Розклад співбесід доступний на екрані «Розклад». Перейти на цей екран можна через спливаюче меню праворуч, натиснувши на розділ «Розклад».',
      },
      question13: {
      ...
      question15: {
        ...
        answer:
          'Все, що вам потрібно — це базова підготовка за обраними вами навичками. Співбесіда відбувається онлайн через Zoom, тому важливо знайти спокійне місце, переконатися в наявності стабільного інтернету та бути готовим до нового досвіду.',
      },
      question16: {
