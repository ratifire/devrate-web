  ...
  translation: {
    ...
    modal: {
      ...
      activation: {
        ...
        text: 'Ваш профіль було деактивовано 03.03.2025. До 02.04.2025 включно Ви можете його активувати і зробит знов видимим для інших користувачів на платформі. Щоб завершити процес активації профілю, необхідно ввести код безпеки. Перевірте свою електронну адресу',
        subtitle: 'Не отримали листа? Перевірте папку «Спам».',
        resend: 'Будь ласка, надішліть запит повторно.',
      },
      confirmation: {
      ...
      general: {
        ...
        deactivated: {
          ...
          list: {
            ...
            text: 'Ви збираєтеся почати процес деактивації свого профілю Skillzzy. Ваш загальнодоступний профіль більше не відображатиметься на платформі, всі Ваші дані будуть приховані від інших користувачів, а особисті листування будуть заморожені. ',
        ...
        modal: {
          ...
          text: 'Ви впевнені, що хочете деактивувати свій профіль Skillzzy? Ваш загальнодоступний профіль більше не відображатиметься на платформі, всі Ваші дані будуть приховані від інших користувачів, а особисті листування будуть заморожені. Також будуть відмінені всі заплановані інтерв’ю.',
    ...
    interviews: {
      ...
      scheduleInterviewModal: {
        ...
        agree: 'Я погоджуюсь на запис співбесіди та її публікацію',
        required: "Це обов'язкове поле",
