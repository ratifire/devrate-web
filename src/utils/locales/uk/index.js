  ...
  translation: {
    ...
    home: {
      ...
      hero: {
        ...
        mainText1: 'Технічні Співбесіди',
        mainText2: ' з підтримкою від',
        mainText3: 'Експертів і Однодумців!',
        mainTextMobile1: 'Нажаль, ми поки що не маємо мобільної версії ;(',
        mainTextMobile2: 'Але це поки що!',
        secondaryText:
          "Вдосконалюйте свої навички в проходженні та проведенні інтерв’ю, практикуючись разом із однодумцями! Отримуйте персоналізовані відгуки та об'єктивні оцінки для впевненої та ефективної підготовки до реальних співбесід!",
        secondaryTextMobile: "Щоб зареєструватися, відкрийте сайт на комп'ютері",
        registration: 'Приєднуйтесь до наc',
      },
      howItWorks: {
        titleText1: 'Як це',
        titleText2: 'працює?',
        card1Title: 'Заповніть профіль',
        card1Text:
          'Створіть свій профіль і заповніть інформацію про свій досвід роботи, навички, досягнення та освіту.',

        card2Title: 'Створіть запит на інтерв’ю',
        card2Text:
          'Оберіть роль: провести інтерв’ю (стати інтерв’юером) чи пройти інтерв’ю (стати респондентом).\n' +
          'А також зручний для себе час та формат.',

        card3Title: 'Отримайте відгук',
        card3Text:
          'Отримайте детальний відгук, який допоможе покращити свої навички та залиште відгук для іншого користувача!',
      },
      aboutUs: {
        title1Part: 'Про',
        title2Part: 'нас',
        ...
        article1Text:
          'Це платформа для тренувальних технічних співбесід, яка допоможе набутися реального практичного досвіду.',

        article2Title: 'Різнобічна спільнота',
        article2Text: 'Спілкуйтеся з іншими розробниками, які готові\n' + 'поділитися своїми знаннями та допомогти.',

        article3Title: 'Дружня атмосфера',
        article3Text: 'Практикуйтесь в просторі, де помилки є природною частиною навчального процесу, а не невдачами.',

        article4Title: 'Деталізований відгук',
        article4Text:
          'Ви отримаєте детальний аналіз. Це допоможе ефективніше підготуватися до справжніх технічних співбесід.',
      },
      about: {
        title: 'Як це працює',
    ...
    modal: {
      ...
      activation: {
        title: 'Хочете активувати свій профіль?',
        description:
          'Ваш профіль було деактивовано ви можете його активувати і зробит знов видимим для інших користувачів на' +
          ' платформі. Щоб завершити процес активації профілю, необхідно ввести код безпеки. Перевірте свою електронну адресу',
        subtitle: 'Не отримали листа? Перевірте папку «Спам».',
      ...
      deactivated: {
        title: 'Деактивувати профіль',
        description:
          'Ви впевнені, що хочете деактивувати свій профіль Skillzzy? Ваш загальнодоступний профіль більше не відображатиметься на платформі, всі Ваші дані будуть приховані від інших користувачів, а особисті листування будуть заморожені. Також будуть відмінені всі заплановані інтерв’ю.',
        agree: 'Я ознайомився та погоджуюсь з Умовами деактивації облікового запису',
        notification: {
          success: 'Ваш профіль успішно деактивовано',
          error: 'Помилка деактивації профілю',
        },
      },
      confirmation: {
    ...
    profile: {
      ...
      modal: {
        ...
        workExperience: {
          ...
          endDateMessage: 'Кінцева дата має бути пізнішою за стартову',
        ...
        education: {
          ...
          startDateMinMessage: 'Стартова дата має бути пізніше 01/01/1950',
          startDateMaxMessage: 'Кінцева дата має бути не пізніше за поточку',
          endDateMessage: 'Кінцева дата має буди пізнішою за стартову',
        },
      },
    },
    specialization: {
      ...
      statistics: {
        ...
        emptyStatistic: 'Наразі у вас не має статистики',
      },
      interviewsChart: {
        conducted: 'Проведено',
        passed: 'Пройдено',
      ...
      modal: {
        specialization: {
          ...
          mastery_helper_text:
            'Рівень для формування Вашої статистики, яка буде відображатися в на сторінці Вашого профілю',
          required: "Це обов'язкове поле",
    ...
    settings: {
      ...
      general: {
        ...
        deactivated: {
          ...
          subTitle: 'Дізнайтеся, як Ви можете деактивувати свій профіль',
          list: {
            title: 'Ваш профіль буде деактивовано',
            description:
              'Ви збираєтеся почати процес деактивації свого профілю Skillzzy. Ваш загальнодоступний профіль більше не відображатиметься на платформі, всі Ваші дані будуть приховані від інших користувачів, а особисті листування будуть заморожені. ',
            subTitle: 'Інша важлива інформація',
            subDescription:
              'Ви можете відновити свій деактивований профіль протягом 30 діб з моменту його деактивації. Для цього Вам буде необхідно ввести свій e-mail та пароль, як при авторизації на платформі, після чого Ви отримаєте код для повторної активації Вашого профілю.',
          },
        },
      },
      notifications: {
    ...
    blogText: {
      ...
      upd3: {
        title: 'Функція зміни часу поданої заявки на співбесіду',
    ...
    interviews: {
      emptyInterviewTabs: {
        ...
        emptyStatistics:
          'Незабаром тут з’явиться ваша аналітика щодо цього інтерв’ю. Очікуйте на відгук від іншого користувача!',
      },
      navigationLinks: {
    ...
    countriesList: {
      ...
      kenya: 'Кенія',
      kiribati: 'Кірібаті',
      korea_north: 'Північна Корея',
      korea_south: 'Південна Корея',
      kosovo: 'Косово',
      kuwait: 'Кувейт',
