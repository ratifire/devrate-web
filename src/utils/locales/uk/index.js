  ...
  translation: {
    ...
    home: {
      ...
      howItWorks: {
        ...
        card2Text:
          'Оберіть роль: провести інтерв’ю (стати інтерв’юером) чи пройти інтерв’ю (стати кандидатом).\n' +
      ...
      about: {
        ...
        text2: 'Проведіть співбесіду зі своїм інтерв’юером чи кандидатом.',
        text3:
    ...
    modal: {
      ...
      personaInterview: {
        ...
        text: 'Надішліть згенероване посилання іншому користувачу, щоб почати зустріч в будь-який зручний час.',
        label: 'Посилання',
        btnCopy: 'Копіювати посилання',
        btnSendMessage: 'Надіслати в чат',
      },
      achievement: {
        title: 'Досягнення',
    ...
    interviews: {
      emptyInterviewTabs: {
        ...
        emptySpecialization:
          'У вас ще немає обраної спеціалізації. Визначте сферу своїх інтересів, щоб отримати доступ до співбесід. Оберіть напрямок, який вас цікавить, і відкрийте нові можливості. Це допоможе вам знайти інтерв’юера чи кандидата, перевірити свої знання та краще підготуватися до майбутніх викликів.',
        emptyStatistics:
      ...
      passedInterviews: {
        ...
        interviewInfoCandidate: 'Кандидат',
    ...
    interviewRequest: {
      ...
      pendingTooltip: {
        ...
        INTERVIEWER: 'Відбувається пошук кандидата',
      },
      requestHeader: {
        titleLauncher: 'як',
