    ...
    profile: {
      ...
      modal: {
        ...
        workExperience: {
          ...
          title_short: 'Посада занадто коротка',
          title_placeholder: 'Інженер-програміст',
          company: 'Company',
          company_long: 'Компанія занадто довге',
          company_short: 'Компанія занадто коротка',
          company_placeholder: 'Простір Аверга',
          description: 'Опис',
          ...
          duty_placeholder: 'Бекенд-розробник',
