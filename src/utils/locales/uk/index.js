export const uk = {
  translation: {
    ...
    countriesList: {
      ...
      Kenya: 'Кенія',
      Kiribati: 'Кірибаті',
      KoreaNorth: 'Північна Корея',
      KoreaSouth: 'Південна Корея',
      Kosovo: 'Косово',
      Kuwait: 'Кувейт',
      ...
      SãoToméAndPríncipe: 'Сан-Томе і Принсіпі',
      ...
      Somalia: 'Сомалі',
      SouthAfrica: 'Південно-Африканська Республіка',
