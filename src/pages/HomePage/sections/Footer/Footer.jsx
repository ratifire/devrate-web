                ...
                <div className={styles.footer__container}>
                    <div className={styles.footer__content}>
                        ...
                        <p className={styles.footer__descriptions}>
                            Technical interview training platform: elevate your skills with both beginners and
                            experienced professionals. Our platform is designed to make the interview preparation
                            process smoother and less stressful for everyone.
                        </p>
                        <div className={styles.footer__developer}>
                            ...
                            <a href='#' target='_blank' className={styles.footer__developerLink}>ratifire.org</a>
                            <div className={styles.footer__policies}>
                                <a href="#" className={styles.footer__policyLink}>Terms and conditions</a>
                        ...
                        <div className={styles.footer__copyright}>
                            ...
                            <p className={styles.footer__trademarks}>All trademarks, logos, and brand names are the property of their respective owners.</p>
                        </div>
                    </div>
                    <div className={styles.contactForm}>
                        <h2 className={styles.contactForm__title}><span className={styles.contactForm__titleFocus}>Get</span> In Touch</h2>
